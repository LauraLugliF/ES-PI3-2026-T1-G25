...
exports.addDepositHandler = void 0;
const https_1 = require("firebase-functions/v2/https");
const logger = __importStar(require("firebase-functions/logger"));
const userRepository_1 = require("../repositories/userRepository");
exports.addDepositHandler = (0, https_1.onRequest)({ region: "southamerica-east1", invoker: "public" }, async (request, response) => {
    var _a, _b, _c, _d;
    try {
        const uid = ((_a = request.query) === null || _a === void 0 ? void 0 : _a.uid) || ((_b = request.body) === null || _b === void 0 ? void 0 : _b.uid);
        const valorEmReais = ((_c = request.query) === null || _c === void 0 ? void 0 : _c.valor) || ((_d = request.body) === null || _d === void 0 ? void 0 : _d.valor);
        ...
        const novoSaldo = await (0, userRepository_1.adicionarDeposito)(uid, depositoEmCentavos);
